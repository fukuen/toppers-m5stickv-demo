...
extern JRESULT jd_prepare (JDEC*, uint32_t(*)(JDEC*,uint8_t*,uint32_t), void*, uint16_t, void*);
extern JRESULT jd_decomp (JDEC*, uint32_t(*)(JDEC*,void*,JRECT*), uint8_t);
